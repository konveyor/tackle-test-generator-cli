...
__options_spec = {
    ...
    'execute': {
        ...
        'compare_to_dev_tests': {
            ...
            'type': bool,
            'default_value': False,
            'help_message': 'create a coverage report that compares between the automatically generated test suite'
                            ' and the developer-writen test suite'
        },
    },

    # "dev_tests" options
    'dev_tests': {
        'help_message': 'information of the developer-writen test suite',
        'build_type': {
            'required': True,
            'is_toml_option': True,
            'is_cli_option': False,
            ...
            'choices': ['ant', 'maven', 'gradle'],
            'default_value': 'ant',
            'help_message': 'build type for compiling and running the developer-writen test suite - either ant, maven or gradle'
        },
        'build_file': {
            'required': True,
            'is_toml_option': True,
            ...
            'default_value': '',
            'relpath_fix_type': 'path',
            'help_message': 'path to build file for compiling and running the developer-writen test suite'
        },
        'build_targets': {
            'required': True,
            'is_toml_option': True,
            ...
            'type': list,
            'default_value': [],
            'help_message': 'list of build targets for compiling and running the developer-writen test suite'
        },
        'coverage_exec_file': {
            'required': False,
            'is_toml_option': True,
            ...
            'default_value': '',
            'relpath_fix_type': 'path',
            'help_message': 'the path to the Jacoco coverage .exec file, generated by the developer-writen build file'
        },
    }
