                    ...
                    <TD width="200" align="left"><B>Run-Time Mode </B>
                        <P align="left">
                            <%
                                ...
                                String names[] = TradeConfig.get__runTimeModeNames();
                                int index = TradeConfig.get__runTimeMode();
                    ...
                    <TD align="left"><B>Order-Processing Mode </B>
                        <P align="left">
                            <%
                                ...
                                names = TradeConfig.get__orderProcessingModeNames();
                                index = TradeConfig.get__orderProcessingMode();
                                for (int i = 0; i < names.length; i++) {
                                    out.print("<INPUT type=\"radio\" name=\"" + configParm + "\" value=\"" + i + "\" ");
                                    if (index == i)
                                        out.print("checked");
                    ...
                    <TD align="left"><B>WebInterface</B>
                        <P align="left">
                            <%
                                ...
                                names = TradeConfig.get__webInterfaceNames();
                                index = TradeConfig.get__webInterface();
                                for (int i = 0; i < names.length; i++) {
                                    out.print("<INPUT type=\"radio\" name=\"" + configParm + "\" value=\"" + i + "\" ");
                                    if (index == i)
                                        out.print("checked");
