...
<BODY bgcolor="#ffffff" link="#000099">
    ...
    <%
        // Mono2Micro: need to expose these fields via getters/setters in TradeConfig.java, hardcoding for now
        // double loginPercentage = (double) ((TradeConfig.getScenarioMixes())[0][TradeConfig.LOGIN_OP]) / 100.0;
        double loginPercentage = (double) ((TradeConfig.getScenarioMixes())[0][2]) / 100.0;
        // double logoutPercentage = (double) ((TradeConfig.getScenarioMixes())[0][TradeConfig.LOGOUT_OP]) / 100.0;
        double logoutPercentage = (double) ((TradeConfig.getScenarioMixes())[0][3]) / 100.0;
        // double buyOrderPercentage = (double) ((TradeConfig.getScenarioMixes())[0][TradeConfig.BUY_OP]) / 100.0;
        double buyOrderPercentage = (double) ((TradeConfig.getScenarioMixes())[0][7]) / 100.0;
        // double sellOrderPercentage = (double) ((TradeConfig.getScenarioMixes())[0][TradeConfig.SELL_OP]) / 100.0;
        double sellOrderPercentage = (double) ((TradeConfig.getScenarioMixes())[0][8]) / 100.0;
        ...
        double registerPercentage = (double) ((TradeConfig.getScenarioMixes())[0][4]) / 100.0;
                                            ...
                                            <TR>
                                                <TD colspan="2"><A
                                                    href="docs/glossary.html">Run-Time
                                                        Mode</A></TD>
                                                <TD colspan="3"><B><%=(TradeConfig.getRunTimeModeNames())[TradeConfig.get__runTimeMode()]%></B></TD>
                                            </TR>
                                            <TR>
                                                <TD colspan="2"><A
                                                    href="docs/glossary.html">Order-Processing
                                                        Mode</A></TD>
                                                <TD colspan="3"><B><%=(TradeConfig.getOrderProcessingModeNames())[TradeConfig.get__orderProcessingMode()]%></B></TD>
                                            </TR>
                                            <TR>
                                                <TD colspan="2"><A
                                                    href="docs/glossary.html">Web
                                                        Interface</A></TD>
                                                <TD colspan="3"><B><%=(TradeConfig.getWebInterfaceNames())[TradeConfig.get__webInterface()]%></B></TD>
                                            </TR>
                                            <TR>
                                                <TD colspan="2"><A
