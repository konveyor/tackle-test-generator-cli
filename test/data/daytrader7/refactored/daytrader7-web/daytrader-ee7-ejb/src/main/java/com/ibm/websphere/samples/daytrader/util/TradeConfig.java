...
public class TradeConfig implements KluInterface {
    ...
    public static String getPage(int pageNumber) {
        ...
        String response_json_str = svc_response.readEntity(String.class);
//        System.out.println("[__TradeConfig__] Response entity: "+response_json_str);
        System.out.println("[__TradeConfig__] Response status code: "+svc_response.getStatus());
        System.out.println("[__TradeConfig__] Response status reason: "+svc_response.getStatusInfo().getReasonPhrase());
//        System.out.println("[__TradeConfig__] Response status family: "+svc_response.getStatusInfo().getFamily());
//        System.out.println("[__TradeConfig__] Response headers: "+svc_response.getHeaders());
//        System.out.println("[__TradeConfig__] Response media type: "+svc_response.getMediaType());
        JsonReader json_reader = Json.createReader(new StringReader(response_json_str));
        JsonObject response_json = json_reader.readObject();
        String response = response_json.getString("return_value");
        svc_response.close();
