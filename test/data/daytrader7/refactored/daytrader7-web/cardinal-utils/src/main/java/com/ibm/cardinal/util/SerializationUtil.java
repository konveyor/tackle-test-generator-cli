...
public class SerializationUtil {
    ...
    static {
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.util.MDBStats", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.util.TimerStat", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.util.TradeConfig", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.OrdersAlertFilter", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.TestServlet", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.TradeAppServlet", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.TradeBuildDB", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.TradeConfigServlet", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.TradeScenarioServlet", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.TradeServletAction", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.TradeWebContextListener", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.ExplicitGC", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingBean", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingCDIBean", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingCDIJSFBean", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingEJBLocal", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingEJBLocalDecorator", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingInterceptor", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingServlet", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingServlet2Servlet", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingServlet2ServletRcv", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingServletCDI", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingServletCDIBeanManagerViaJNDI", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.prims.PingServletWriter", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.websocket.ActionDecoder", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.websocket.ActionMessage", "USER_REMOTE_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.websocket.MarketSummaryWebSocket", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.websocket.RecentStockChangeList", "USER_REMOTE_TYPE");
    }
