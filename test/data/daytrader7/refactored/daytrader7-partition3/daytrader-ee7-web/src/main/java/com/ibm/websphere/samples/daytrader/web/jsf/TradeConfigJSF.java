...
public class TradeConfigJSF {
    ...
    private String runtimeMode = TradeConfig.get__runTimeModeNames()[TradeConfig.getRunTimeMode()];
    private String orderProcessingMode = TradeConfig.get__orderProcessingModeNames()[TradeConfig.getOrderProcessingMode()];
    ...
    private String webInterface = TradeConfig.get__webInterfaceNames()[TradeConfig.getWebInterface()];
    ...
    private String[] runtimeModeList = TradeConfig.get__runTimeModeNames();
    private String[] orderProcessingModeList = TradeConfig.get__orderProcessingModeNames();
    //private String[] cachingTypeList = TradeConfig.cachingTypeNames;
    private String[] webInterfaceList = TradeConfig.get__webInterfaceNames();
