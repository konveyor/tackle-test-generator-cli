...
public class SerializationUtil {
    ...
    static {
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.beans.RunStatsDataBean", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.direct.KeySequenceDirect", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.direct.TradeDirect", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.util.KeyBlock", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.jsf.JSFLoginFilter", "USER_LOCAL_TYPE");
