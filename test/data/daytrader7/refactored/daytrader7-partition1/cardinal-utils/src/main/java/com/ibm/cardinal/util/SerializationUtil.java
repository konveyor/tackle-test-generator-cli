...
public class SerializationUtil {
    ...
    static {
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.TradeAction", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.beans.MarketSummaryDataBean", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.ejb3.DTBroker3MDB", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.ejb3.DTStreamer3MDB", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.ejb3.MarketSummarySingleton", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.ejb3.TradeSLSBBean", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.ejb3.TradeSLSBBean.$quotePriceComparator", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.entities.AccountDataBean", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.entities.AccountProfileDataBean", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.entities.HoldingDataBean", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.entities.OrderDataBean", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.entities.QuoteDataBean", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.util.CompleteOrderThread", "USER_REMOTE_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.util.FinancialUtils", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.util.Log", "USER_LOCAL_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.util.TradeConfig", "USER_LOCAL_TYPE");
