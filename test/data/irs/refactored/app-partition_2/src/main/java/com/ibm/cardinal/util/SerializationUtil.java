...
public class SerializationUtil {
    ...
    static {
        ...
        type_category_map.put("irs.Employer", "USER_LOCAL_TYPE");
        type_category_map.put("irs.Salary", "USER_LOCAL_TYPE");
        type_category_map.put("irs.IRS", "USER_LOCAL_TYPE");
        type_category_map.put("irs.BusinessProcess", "USER_REMOTE_TYPE");
        type_category_map.put("irs.Employee", "USER_LOCAL_TYPE");
    }
