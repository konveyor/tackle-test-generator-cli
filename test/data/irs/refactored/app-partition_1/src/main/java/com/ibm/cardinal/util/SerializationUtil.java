...
public class SerializationUtil {
    ...
    static {
        ...
        type_category_map.put("irs.AppTest", "USER_REMOTE_TYPE");
        type_category_map.put("irs.Employer", "USER_REMOTE_TYPE");
        type_category_map.put("irs.Salary", "USER_REMOTE_TYPE");
        type_category_map.put("irs.IRS", "USER_REMOTE_TYPE");
        type_category_map.put("irs.BusinessProcess", "USER_LOCAL_TYPE");
        type_category_map.put("irs.Employee", "USER_REMOTE_TYPE");
    }
