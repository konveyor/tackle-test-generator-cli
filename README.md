...
| compare_to_dev_tests                |                                  | compare execution coverage to dev test suite coverage                                                                                   |
|                                     |                                  |                                                                                                                                         |
| dev_tests                           |                                  | user test suite information                                                                                                             |
| build_type*                         |                                  | build file type for compiling and running the test suite - either ant, maven or gradle                                                  |
| build_file*                         |                                  | build file for compiling and running the user test suite                                                                                |
| build_targets*                      |                                  | build target for compiling and running the user test suite                                                                              |
| coverage_exec_file                  |                                  | the path to the coverage .exec file, created by the user build file                                                                     |
|                                     |                                  |                                                                                                                                         |
