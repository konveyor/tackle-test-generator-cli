...
| compare_to_dev_tests                |                                  | create a coverage report that compare between the test suite and the user test suite                                                    |
|                                     |                                  |                                                                                                                                         |
| dev_tests                           |                                  | information of the user test suite                                                                                                      |
| build_type*                         |                                  | build type for compiling and running the user test suite - either ant, maven or gradle                                                  |
| build_file*                         |                                  | path to build file for compiling and running the user test suite                                                                        |
| build_targets*                      |                                  | list of build targets for compiling and running the user test suite                                                                     |
| coverage_exec_file                  |                                  | the path to the Jacoco coverage .exec file, generated by the user build file                                                            |
|                                     |                                  |                                                                                                                                         |
