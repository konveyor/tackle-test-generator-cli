...
| coverage_threshold_percentage       |                                  | classes with developer-written instruction percentage of coverage higher than the threshold, are excluded from test generation               