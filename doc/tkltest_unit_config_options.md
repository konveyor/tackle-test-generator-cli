...
| app_build_config_files              |                                  | list of paths to app build files for the specified app build type                                                                       |
...
| max_augment_memory                  | -mam/--maximal-augment-memory    | maximal heap size (in MB) used for augmentation                                                                                         |
...
| coverage_threshold_percentage       |                                  | classes with developer-written instruction coverage higher than the threshold, are excluded from test generation               