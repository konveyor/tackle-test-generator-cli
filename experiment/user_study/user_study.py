...
def generate_study(tests_dir, num_samples):
    ...
    questions about the readability and usefulness of the test cases.
        ...
        Args:
            ...
            num_samples (str): Number of test methods to sample. Default is 20.
        """

    tests_dir = os.path.abspath(tests_dir)
    files_to_methods, sampled_tests_dir = __select_samples(tests_dir, num_samples)
    __create_questionnaire(files_to_methods, sampled_tests_dir)

def __select_samples(tests_dir, num_samples):
...
def __get_method_names(filename):
...
def main():
    ...
    parser.add_argument('-n', '--num-samples', type=int, dest='num_samples', default=20,
                        help='Number of test methods to samples')
    ...
    generate_study(args.tests_dir, args.num_samples)
